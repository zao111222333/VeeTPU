This is designed based on 16 inputs of 14+13+13+13 with accumulate.
/*********************RTL Structure*********************/
>PE_16in_top.v
    ...
    >pip2_processing.v
        ...
        >lza_128.v
              -The module is leading zero anticipator unit. The bit-width of leading zero anticipator unit indicator architecture for each input is 107-bit and the bit-width of output is 7, which is definitely compatible with different precision. The max width supported is 128bit.
    >pip3_processing.v
    ...
    >fp_acc.v
          -Using to add two FP64 tegeter. It is also supporting the accumulate of FP32 and FP16.
       >lza_64w.v
              -The module is leading zero anticipator unit. The max width supported is 64bit.
/*********************General Module*********************/
>cpa.v
    -ripple-carryadder
>CSA3_2.v
...
/*********************Simulation File*********************/
>tb_top_fp64.v
    -This file are use to do FP64 random test. This is not a complete testing. Except for the case where the exponent is all zero, the other test cases in random are all pass. For the case where the exponent is all zero, the manual verification is passed. The accumulate test is just for postive number. 
>tb_top_fp16&fp32.v
    -This file are use to do FP32 and FP16 test. This is not a complete testing. 
